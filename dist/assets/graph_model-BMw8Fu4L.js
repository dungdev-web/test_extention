 ...
 * limitations under the License.
 * =============================================================================
 */function Tm(t,e=null,n=!1){const r={x:m(t,"x","all","bool")},a={axis:e,keepDims:n};return w.runKernel(Eo,r,a)}const Uc=b({all_:Tm});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Em(t,e=null,n=!1){const r={x:m(t,"x","any","bool")},a={axis:e,keepDims:n};return w.runKernel($o,r,a)}const jc=b({any_:Em});/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Bm(t,e){const s={x:m(t,"x","reshape","string_or_numeric")},r={shape:e};return w.runKernel(yu,s,r)}const E=b({reshape_:Bm});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Pm(t,e,n,s,r){const a=m(t,"x","avgPool","float32"),o=1;g(Ye(n,o),()=>`Error in avgPool: Either strides or dilations must be 1. Got strides ${n} and dilations '${o}'`);let i=a,u=!1;a.rank===3&&(u=!0,i=E(a,[1,a.shape[0],a.shape[1],a.shape[2]])),g(i.rank===4,()=>`Error in avgPool: x must be rank 4 but got rank ${i.rank}.`),Ae("avgPool",s,r);const c={x:i},h={filterSize:e,strides:n,pad:s,dimRoundingMode:r};let l=w.runKernel(Do,c,h);return l=X(l,a.dtype),u?E(l,[l.shape[1],l.shape[2],l.shape[3]]):l}const Ir=b({avgPool_:Pm});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Mm(t){const n={x:m(t,"x","sigmoid","float32")};return w.runKernel(Fu,n)}const Et=b({sigmoid_:Mm});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function wy(t){const e=m(t,"x","logSigmoid");return Me(s=>({value:Ce(Wr(Ce(s))),gradFunc:o=>I(o,Et(Ce(s)))}))(e)}const Ml=b({logSigmoid_:wy});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ty(t,e=null,n=!1){const s=m(t,"x","logSumExp"),r=kn(e,s.shape),a=$t(s,r,!0),o=P(s,a),i=lt(o),u=H(i,r),c=Zt(u),h=C(E(a,c.shape),c);if(n){const l=Fn(h.shape,r);return E(h,l)}return h}const Mr=b({logSumExp_:Ty});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $y(t){const n={x:m(t,"x","logicalNot","bool")};return w.runKernel(Bi,n)}const Ur=b({logicalNot_:$y});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ee(t,e){Ft(t);const n=ze(t,e);if(n.length!==1)throw new Error("tensor1d() requires values to be a flat/TypedArray");return pt(t,null,n,e)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */async function $0(t,e,n){const s=m(t,"tensor","boolMask"),r=m(e,"mask","boolMask","bool"),a=n??0,o=r.rank,i=s.shape;g(o>0,()=>"mask cannot be scalar"),fe(i.slice(a,a+o),r.shape,"mask's shape must match the first K dimensions of tensor's shape,");let u=1;for(let S=a;S<a+o;S++)u*=i[S];const c=i.slice(0,a).concat([u],i.slice(a+o)),h=E(s,c),l=E(r,[-1]),f=await da(l),d=gs(f,[1]),y=Br(h,d,a);return t!==s&&s.dispose(),e!==r&&r.dispose(),d.dispose(),h.dispose(),l.dispose(),f.dispose(),y}const Xh=$0;/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ws(t,e,n){if(n==null||n==="linear")return t;if(n==="relu")return I(t,ha(e));throw new Error(`Cannot compute gradient for fused activation ${n}.`)}function Ns(t,e){let n=e;const s=Or(t.shape,e.shape);return s.length>0&&(n=H(n,s)),E(n,t.shape)}function Ss(t,e,n,s){if(e==="linear")return t;if(e==="relu")return Bn(t);if(e==="elu")return Fr(t);if(e==="relu6")return ia(t);if(e==="prelu")return Xr(t,n);if(e==="leakyrelu")return zr(t,s);if(e==="sigmoid")return Et(t);throw new Error(`Unknown fused activation ${e}.`)}const Ts=(t,e)=>!(t>0)||e==="linear";/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function P0(t,e,n,s,r,a=[1,1],o){let i=t;t.rank===3&&(i=E(t,[1,t.shape[0],t.shape[1],t.shape[2]]));let u=e;u.rank===3&&(u=E(e,[1,e.shape[0],e.shape[1],e.shape[2]]));const c={x:i,dy:u},h={strides:s,pad:r,dimRoundingMode:o,dilations:a,filterShape:n};return w.runKernel(si,c,h)}const z0=b({depthwiseConv2dNativeBackpropFilter_:P0});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function V0(t,e,n,s,r,a=[1,1],o){let i=e,u=!1;e.rank===3&&(u=!0,i=E(e,[1,e.shape[0],e.shape[1],e.shape[2]]));const c={dy:i,filter:n},h={strides:s,pad:r,dimRoundingMode:o,dilations:a,inputShape:t},l=w.runKernel(ri,c,h);return u?E(l,[l.shape[1],l.shape[2],l.shape[3]]):l}const W0=b({depthwiseConv2dNativeBackpropInput_:V0});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function j0({a:t,b:e,transposeA:n=!1,transposeB:s=!1,bias:r,activation:a="linear",preluActivationWeights:o,leakyreluAlpha:i=.2}){if(Ts(w.state.gradientDepth,a)===!1){let L=V(t,e,n,s);return r!=null&&(L=C(L,r)),Ss(L,a,o,i)}let u=m(t,"a","fused matMul"),c=m(e,"b","fused matMul");[u,c]=ee(u,c);const h=n?u.shape[u.rank-2]:u.shape[u.rank-1],l=s?c.shape[c.rank-1]:c.shape[c.rank-2],f=n?u.shape[u.rank-1]:u.shape[u.rank-2],d=s?c.shape[c.rank-2]:c.shape[c.rank-1],y=u.shape.slice(0,-2),S=c.shape.slice(0,-2),N=U(y),T=U(S);g(h===l,()=>`Error in fused matMul: inner shapes (${h}) and (${l}) of Tensors with shapes ${u.shape} and ${c.shape} and transposeA=${n} and transposeB=${s} must match.`);const $=ne(u.shape.slice(0,-2),c.shape.slice(0,-2)).concat([f,d]),k=n?E(u,[N,h,f]):E(u,[N,f,h]),v=s?E(c,[T,d,l]):E(c,[T,l,d]);let x;r!=null&&(x=m(r,"bias","fused matMul"),[x]=ee(x,u),ne($,x.shape));let O;o!=null&&(O=m(o,"prelu weights","fused matMul"));const D=(L,M)=>{const[j,Y,se,$e]=M,je=ws(E(L,se.shape),se,a);let Lt,Bt;if(!n&&!s?(Lt=V(je,Y,!1,!0),Bt=V(j,je,!0,!1)):!n&&s?(Lt=V(je,Y,!1,!1),Bt=V(je,j,!0,!1)):n&&!s?(Lt=V(Y,je,!1,!0),Bt=V(j,je,!1,!1)):(Lt=V(Y,je,!0,!0),Bt=V(je,j,!0,!0)),r!=null){const Pp=Ns($e,je);return[Lt,Bt,Pp]}else return[Lt,Bt]},F={a:k,b:v,bias:x,preluActivationWeights:O},B={transposeA:n,transposeB:s,activation:a,leakyreluAlpha:i};return r==null?Me((M,j,Y)=>{const se=w.runKernel(Ds,F,B);return Y([M,j,se]),{value:E(se,$),gradFunc:D}})(k,v):Me((M,j,Y,se)=>{const $e=w.runKernel(Ds,F,B);return se([M,j,$e,Y]),{value:E($e,$),gradFunc:D}})(k,v,x)}const q0=b({fusedMatMul_:j0});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function X0(t,e,n,s=!1,r=0){let a=0;const o=[];for(;a+e<=t.size;)o.push(q(t,a,e)),a+=n;if(s)for(;a<t.size;){const i=a+e-t.size,u=ue([q(t,a,e-i),tn([i],r)]);o.push(u),a+=n}return o.length===0?jt([],[0,e]):E(ue(o),[o.length,e])}const rp=b({frame_:X0});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function zw(t,e=!1){if(g(t.rank>=2,()=>`qr() requires input tensor to have a rank >= 2, but got rank ${t.rank}`),t.rank===2)return Ua(t,e);{const n=t.shape.slice(0,t.shape.length-2).reduce((u,c)=>u*c),s=ft(E(t,[n,t.shape[t.shape.length-2],t.shape[t.shape.length-1]]),0),r=[],a=[];s.forEach(u=>{const[c,h]=Ua(u,e);r.push(c),a.push(h)});const o=E(Ue(r,0),t.shape),i=E(Ue(a,0),t.shape);return[o,i]}}function Ua(t,e=!1){return w.tidy(()=>{g(t.shape.length===2,()=>`qr2d() requires a 2D Tensor, but got a ${t.shape.length}D Tensor.`);const n=t.shape[0],s=t.shape[1];let r=Rr(n),a=Xe(t);const o=jt([[1]],[1,1]);let i=Xe(o);const u=n>=s?s:n;for(let c=0;c<u;++c){const h=a,l=i,f=r;[i,a,r]=w.tidy(()=>{const d=q(a,[c,c],[n-c,1]),y=Cn(d),S=q(a,[c,c],[1,1]),N=Ze(Rn(S,0),jt([[-1]]),jt([[1]])),T=P(S,I(N,y)),A=K(d,T);A.shape[0]===1?i=Xe(o):i=ue([o,q(A,[1,0],[A.shape[0]-1,A.shape[1]])],0);const $=Ce(K(V(N,T),y)),k=q(a,[c,0],[n-c,s]),v=I($,i),x=$n(i);if(c===0)a=P(k,V(v,V(x,k)));else{const F=P(k,V(v,V(x,k)));a=ue([q(a,[0,0],[c,s]),F],0)}const O=$n(v),D=q(r,[0,c],[n,r.shape[1]-c]);if(c===0)r=P(D,V(V(D,i),O));else{const F=P(D,V(V(D,i),O));r=ue([q(r,[0,0],[n,c]),F],1)}return[i,a,r]}),pe([h,l,f])}return!e&&n>s&&(r=q(r,[0,0],[n,s]),a=q(a,[0,0],[s,s])),[r,a]})}const Vw=b({qr_:zw});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function j1(t,e,n){const s=m(t,"labels","confusionMatrix"),r=m(e,"predictions","confusionMatrix");g(n==null||n>0&&Number.isInteger(n),()=>`If provided, numClasses must be a positive integer, but got ${n}`),g(s.rank===1,()=>`Expected the rank of labels to be 1, but got ${s.rank}`),g(r.rank===1,()=>`Expected the rank of predictions to be 1, but got ${r.rank}`),g(s.shape[0]===r.shape[0],()=>`Mismatch in the number of examples: ${s.shape[0]} vs. ${r.shape[0]}. Labels and predictions should have the same number of elements.`),g(n>0&&Number.isInteger(n),()=>`numClasses is required to be a positive integer, but got ${n}`);const a=ns(X(s,"int32"),n),o=ns(X(r,"int32"),n),i=$n(a),u=V(i,o);return X(u,"int32")}const q1=b({confusionMatrix_:j1});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */class lT{constructor(e,n,s,r,a,o,i){this.name=e,this.dtype=n,this.maxSize=s,this.elementShape=r,this.identicalElementShapes=a,this.dynamicSize=o,this.clearAfterRead=i,this.tensors=[],this.closed_=!1,this.idTensor=z(0),De(this.idTensor)}get id(){return this.idTensor.id}get closed(){return this.closed_}clearAndClose(e){this.tensors.forEach(n=>{(e==null||!e.has(n.tensor.id))&&n.tensor.dispose()}),this.tensors=[],this.closed_=!0,this.idTensor.dispose()}size(){return this.tensors.length}read(e){if(this.closed_)throw new Error(`TensorArray ${this.name} has already been closed.`);if(e<0||e>=this.size())throw new Error(`Tried to read from index ${e}, but array size is: ${this.size()}`);const n=this.tensors[e];if(n.cleared)throw new Error(`TensorArray ${this.name}: Could not read index ${e} twice because it was cleared after a previous read (perhaps try setting clear_after_read = false?).`);return this.clearAfterRead&&(n.cleared=!0),n.read=!0,n.tensor}readMany(e){return e.map(n=>this.read(n))}write(e,n){if(this.closed_)throw new Error(`TensorArray ${this.name} has already been closed.`);if(e<0||!this.dynamicSize&&e>=this.maxSize)throw new Error(`Tried to write to index ${e}, but array is not resizeable and size is: ${this.maxSize}`);const s=this.tensors[e]||{};if(n.dtype!==this.dtype)throw new Error(`TensorArray ${this.name}: Could not write to TensorArray index ${e},
        ...
        ${s}, and tensor's shape is: ${n.shape}`);if(!this.dynamicSize&&e.length!==this.maxSize)throw new Error(`TensorArray's size is not equal to the size of lengths (${this.maxSize} vs. ${e.length}), and the TensorArray is not marked as dynamically resizeable`);const a=s===0?0:n.size/s,o=[];W(()=>{n=E(n,[1,s,a]);for(let u=0;u<e.length;++u){const h=[0,u===0?0:r[u-1],0],l=[1,e[u],a];o[u]=E(q(n,h,l),this.elementShape)}return o});const i=[];for(let u=0;u<e.length;u++)i[u]=u;this.writeMany(i,o)}}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
